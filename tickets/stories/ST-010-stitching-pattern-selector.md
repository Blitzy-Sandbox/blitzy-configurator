---
id: ST-010
title: Select Stitching Pattern from Six Named Patterns
epic: EP-003
layer: frontend
points: 3
priority: high
...
As an end user, I want to pick from six named stitching patterns, so that I can choose a visual identity that fits my design.
