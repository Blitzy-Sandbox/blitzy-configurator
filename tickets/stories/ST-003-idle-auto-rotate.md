...
- [ ] After the configured idle interval elapses with no user input, the ball begins rotating automatically at the configured angular velocity.
...
- [ ] Auto-rotation direction and angular velocity match the documented configuration values.
