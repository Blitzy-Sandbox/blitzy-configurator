...
- [ ] The design summary panel displays the current primary color, secondary color, accent color, stitching pattern, material finish, and logo state in human-readable form.
